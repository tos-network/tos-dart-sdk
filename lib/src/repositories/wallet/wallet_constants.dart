import 'package:tos_dart_sdk/src/repositories/common/tos_constants.dart';

/// The RPC methods that can be called on the wallet.
enum WalletMethod implements TosJsonKey {
  ...
  /// When no parameter is set, default asset is TOS.
  ...
  ///
  /// NOTE: Amount set are in atomic units, for TOS it would 100000 to
  /// represents 1 TOS because of 5 decimals precision.
...
enum WalletEvent implements TosJsonKey {
