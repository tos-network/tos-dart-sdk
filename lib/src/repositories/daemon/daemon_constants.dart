...
enum DaemonMethod implements TosJsonKey {
  ...
  /// Retrieve current height (DAG depth) of the chain.
  ...
  /// Retrieve all blocks at a specific height (DAG height).
  ...
  /// Get up-to-date asset's balance for a specific address.
  ///
  /// https://github.com/tos-network/tos-blockchain/blob/dev/API.md#method-get_stable_balance
...
enum DaemonEvent implements TosJsonKey {
  /// New block event.
  newBlock('new_block'),
