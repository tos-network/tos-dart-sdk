...
@JsonKey(name: 'height') int get height;@JsonKey(name: 'topoheight') int get topoHeight;@JsonKey(name: 'stable_height') int? get stableHeight;@JsonKey(name: 'pruned_topoheight') int? get prunedTopoHeight;@JsonKey(name: 'top_block_hash') String get topBlockHash;@JsonKey(name: 'circulating_supply') int? get circulatingSupply;@JsonKey(name: 'maximum_supply') int? get maximumSupply;@JsonKey(name: 'burned_supply') int? get burnedSupply;@JsonKey(name: 'emitted_supply') int? get emittedSupply;@JsonKey(name: 'difficulty') String get difficulty;@JsonKey(name: 'block_time_target') int? get blockTimeTarget;@JsonKey(name: 'average_block_time') int? get averageBlockTime;@JsonKey(name: 'bps') int? get bps;@JsonKey(name: 'actual_bps') int? get actualBps;@JsonKey(name: 'block_reward') int? get blockReward;@JsonKey(name: 'mempool_size') int get mempoolSize;@JsonKey(name: 'version') String get version;@JsonKey(name: 'block_version') int? get blockVersion;@JsonKey(name: 'network') Network get network;@JsonKey(name: 'miner_reward') int? get minerReward;@JsonKey(name: 'dev_reward') int? get devReward;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,height,topoHeight,stableHeight,prunedTopoHeight,topBlockHash,circulatingSupply,maximumSupply,burnedSupply,emittedSupply,difficulty,blockTimeTarget,averageBlockTime,bps,actualBps,blockReward,mempoolSize,version,blockVersion,network,minerReward,devReward]);

@override
String toString() {
  return 'GetInfoResult(height: $height, topoHeight: $topoHeight, stableHeight: $stableHeight, prunedTopoHeight: $prunedTopoHeight, topBlockHash: $topBlockHash, circulatingSupply: $circulatingSupply, maximumSupply: $maximumSupply, burnedSupply: $burnedSupply, emittedSupply: $emittedSupply, difficulty: $difficulty, blockTimeTarget: $blockTimeTarget, averageBlockTime: $averageBlockTime, bps: $bps, actualBps: $actualBps, blockReward: $blockReward, mempoolSize: $mempoolSize, version: $version, blockVersion: $blockVersion, network: $network, minerReward: $minerReward, devReward: $devReward)';
}
...
@useResult
$Res call({
@JsonKey(name: 'height') int height,@JsonKey(name: 'topoheight') int topoHeight,@JsonKey(name: 'stable_height') int? stableHeight,@JsonKey(name: 'pruned_topoheight') int? prunedTopoHeight,@JsonKey(name: 'top_block_hash') String topBlockHash,@JsonKey(name: 'circulating_supply') int? circulatingSupply,@JsonKey(name: 'maximum_supply') int? maximumSupply,@JsonKey(name: 'burned_supply') int? burnedSupply,@JsonKey(name: 'emitted_supply') int? emittedSupply,@JsonKey(name: 'difficulty') String difficulty,@JsonKey(name: 'block_time_target') int? blockTimeTarget,@JsonKey(name: 'average_block_time') int? averageBlockTime,@JsonKey(name: 'bps') int? bps,@JsonKey(name: 'actual_bps') int? actualBps,@JsonKey(name: 'block_reward') int? blockReward,@JsonKey(name: 'mempool_size') int mempoolSize,@JsonKey(name: 'version') String version,@JsonKey(name: 'block_version') int? blockVersion,@JsonKey(name: 'network') Network network,@JsonKey(name: 'miner_reward') int? minerReward,@JsonKey(name: 'dev_reward') int? devReward
});
...
@override@JsonKey(name: 'stable_height') final  int? stableHeight;
...
/// Create a copy of GetInfoResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? height = null,Object? topoHeight = null,Object? stableHeight = freezed,Object? prunedTopoHeight = freezed,Object? topBlockHash = null,Object? circulatingSupply = freezed,Object? maximumSupply = freezed,Object? burnedSupply = freezed,Object? emittedSupply = freezed,Object? difficulty = null,Object? blockTimeTarget = freezed,Object? averageBlockTime = freezed,Object? bps = freezed,Object? actualBps = freezed,Object? blockReward = freezed,Object? mempoolSize = null,Object? version = null,Object? blockVersion = freezed,Object? network = null,Object? minerReward = freezed,Object? devReward = freezed,}) {
